...
public class MovieController {
    ...
    public ResponseResult<Page<MovieVO>> getMovies(
    ...
    public ResponseResult<MovieVO> getMovie(@PathVariable Long id) {
    ...
    public ResponseResult<MovieVO> createMovie(@Valid @RequestBody MovieDTO movieDTO) {
    ...
    public ResponseResult<MovieVO> updateMovie(
    ...
    public ResponseResult<MovieVO> updateMovieStatus(
            @PathVariable Long id,
    ...
    public ResponseResult<List<MovieVO>> getFeaturedMovies(
    ...
    public ResponseResult<List<MovieVO>> getLatestMovies(
            @RequestParam(defaultValue = "6") int limit) {
    ...
    public ResponseResult<List<MovieVO>> getPopularMovies(
            @RequestParam(defaultValue = "6") int limit) {
